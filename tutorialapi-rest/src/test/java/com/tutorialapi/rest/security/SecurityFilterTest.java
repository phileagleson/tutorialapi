...
public class SecurityFilterTest {
    ...
    private String testNotAuthorized(MultivaluedMap<String, String> headers) {
        ...
        NotAuthorizedException notAuthorized = Assertions.assertThrows(
    ...
    public void testFilterWithAllHeaders() {
        ...
        //Mockito
        //    .verify(containerRequestContext, Mockito.times(1))
        //    .setSecurityContext(ArgumentMatchers.eq(securityContext));
    }
}
